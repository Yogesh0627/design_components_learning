...
const ThemeToggle = () => {
  ...
  return (
    <button onClick={SWITCH_THEME} className='absolute size-8 border border-neutral-200 dark:border-neutral-800 rounded-md flex items-center justify-center top-4 right-4'>
